...
public enum GuildStage {
    STAGE_5("Stage 5", 5, 186000, 50, StageReward.EXP_BONUS),
    STAGE_4("Stage 4", 4, 94500, 45, StageReward.COMBAT_BONUS),
    STAGE_3("Stage 3", 3, 39000, 40, StageReward.MOUNT_SPEED_BONUS),
    STAGE_2("Stage 2", 2, 10500, 35, StageReward.BANNER),
    STAGE_1("Stage 1", 1, 1092, 30, StageReward.NONE),
    STAGE_0("Stage 0", 0, 0, 25, StageReward.NONE);
